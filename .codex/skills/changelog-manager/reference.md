...
```markdown
### Added
- User authentication with OAuth2 support (Codex, 2025-01-16)
...
```markdown
### Changed
- Refactored database migrations to use Drizzle ORM (Codex, 2025-01-14)
  - **Context:** PR #45
```
...
```markdown
### Security
- Fixed SQL injection vulnerability in search (Codex, 2025-01-12)
...
### Fixed
- Login session timeout on mobile browsers (Codex, 2025-01-15)
...
### Changed
- Refactored authentication to use JWT tokens (Codex, 2025-01-14)
...
### Deprecated
- Legacy REST API v1 endpoints (Codex, 2025-01-13)
...
### Added
- Initial release (Codex, 2025-01-05)
...
```markdown
### Added
- OAuth2 support (Codex, 2025-01-16)
  - **Context:** Auto-generated from git history

### Fixed
- Rate limit error handling in API (Codex, 2025-01-16)
  - **Context:** Auto-generated from git history

### Changed
- Migrated to Prisma ORM (Codex, 2025-01-16)
  - **Context:** Auto-generated from git history

### Documentation
- Updated README (Codex, 2025-01-16)
```
...
### Added
- Feature A (Codex, 2025-01-15)
- Feature B (Gemini CLI, 2025-01-14)

### Fixed
- Bug X (Codex, 2025-01-13)

...
- **Gemini CLI hooks** (intercept permission prompts and route them to the relay when in "away mode")
...
5. **A real Gemini CLI session** that triggers tool permission prompts

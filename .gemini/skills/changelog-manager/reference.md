...
```markdown
### Added
- User authentication with OAuth2 support (Gemini CLI, 2025-01-16)
...
```markdown
### Changed
- Refactored database migrations to use Drizzle ORM (Gemini CLI, 2025-01-14)
  - **Context:** PR #45
```
...
```markdown
### Security
- Fixed SQL injection vulnerability in search (Gemini CLI, 2025-01-12)
...
### Added
- User profile editing with avatar upload (Gemini CLI, 2025-01-16)
  - **Context:** [PRD](tasks/0001-prd-user-profile.md) | Task 1.2 | PR #42
  - **Details:** Supports PNG/JPG, max 5MB, auto-resize to 200x200
- Real-time notifications via WebSocket (Gemini CLI, 2025-01-16)
...
### Fixed
- Login session timeout on mobile browsers (Gemini CLI, 2025-01-15)
...
### Changed
- Refactored authentication to use JWT tokens (Gemini CLI, 2025-01-14)
...
### Deprecated
- Legacy REST API v1 endpoints (Gemini CLI, 2025-01-13)
  - **Context:** [PRD](tasks/0008-prd-api-v2.md)
  - **Details:** Will be removed in v2.0.0, use /api/v2 instead

### Security
- Patched XSS vulnerability in message rendering (Gemini CLI, 2025-01-13)
  - **Context:** PR #49
...
### Added
- Initial release (Gemini CLI, 2025-01-05)
...
```markdown
### Added
- OAuth2 support (Gemini CLI, 2025-01-16)
  - **Context:** Auto-generated from git history

### Fixed
- Rate limit error handling in API (Gemini CLI, 2025-01-16)
  - **Context:** Auto-generated from git history

### Changed
- Migrated to Prisma ORM (Gemini CLI, 2025-01-16)
  - **Context:** Auto-generated from git history

### Documentation
- Updated README (Gemini CLI, 2025-01-16)
```
...
### Added
- Feature A (Gemini CLI, 2025-01-15)
- Feature B (Gemini CLI, 2025-01-14)

### Fixed
- Bug X (Gemini CLI, 2025-01-13)

...
1. **Detect AI Model/CLI**
   ...
   # Gemini CLI: Check for CLAUDE_CODE_VERSION env var or .claude directory
...
- **Attribution** - Which AI model/CLI made the change (Gemini CLI, Gemini CLI, etc.)
...
```markdown
### Changed
- Refactored database connection pooling (Gemini CLI, 2025-01-14)
